...
class CSVParser {
    ...
    public:
        ...
        MemorySpecification getMemSpecFromCSV(const std::string& id){
            ...
            memspec.memArchSpec.twoVoltageDomains = memoryType.hasTwoVoltageDomains();
            memspec.memArchSpec.dll               = memoryType.hasDll();
            memspec.memArchSpec.termination       = memoryType.hasTermination();
            memspec.memPowerSpec.capacitance = memoryType.getCapacitance();
            memspec.memPowerSpec.ioPower     = memoryType.getIoPower();
            memspec.memPowerSpec.wrOdtPower  = memoryType.getWrOdtPower();
            memspec.memPowerSpec.termRdPower = memoryType.getTermRdPower();
            memspec.memPowerSpec.termWrPower = memoryType.getTermWrPower();
            // }
